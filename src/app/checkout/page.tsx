...
export default async function CheckoutPage() {
  ...
  return <CheckoutForm initialCustomer={currentUser ? { name: currentUser.name, email: currentUser.email, phone: currentUser.phone, street: address?.street, city: address?.city, state: address?.state, postalCode: address?.postalCode } : undefined} />;
}
